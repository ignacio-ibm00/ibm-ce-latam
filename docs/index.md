...
> Portfolio de assets de Inteligencia Artificial del equipo de **Client Engineering LATAM** — IBM.  
> Documentación estandarizada para sellers, arquitectos y AI engineers.
...
<a href="pilotos/telecom/" class="portfolio-card">
  ...
  <div class="card-footer">
    ...
    <span>watsonx.data intelligence</span>
  </div>
</a>
...
<a href="workshops/tech-summit-labs-2026/" class="portfolio-card">
  <div class="card-category">🏆 Evento</div>
  <div class="card-title">Tech Summit Labs 2026</div>
  <div class="card-description">Workshop Hub para el Tech Summit Argentina 2026 — portal de labs con guías para participantes e instructores.</div>
  <div class="card-footer">
    <span class="badge badge-completed">✔️ Completado</span>
...
- **Sellers / Arquitectos**: en cada asset encontrás el caso de uso, el one-pager ejecutivo y el diagrama de arquitectura de alto nivel.
- **AI Engineers**: al final de cada página hay una sección técnica colapsable con stack, instalación y guía de replicación.
- **Contribuir**: leé el [CONTRIBUTING.md](https://github.com/ibm-ce-latam/ce-latam-ai-portfolio/blob/main/CONTRIBUTING.md) del repositorio.
